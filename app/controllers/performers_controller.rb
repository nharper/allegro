...
class PerformersController < ApplicationController
  ...
  def photo
    ...
    if @performer.photo
      render :plain => @performer.photo, :content_type => 'image/png'
    else
      ...
      render :plain => Base64.decode64('iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAACklEQVR4nGMAAQAABQABDQottAAAAABJRU5ErkJggg=='), :content_type => 'image/png'
    end
  end
